        ...
        if(new_pad & BUTTON_CROSS) {
            ...
            switch(function_menu) {
                ...
                case 3:
                    ...
                    if(Get_OSK_String_no_lang("Find String", (char *) find, 256)==0) {
                        u64 finded;
                ...
                case 4:
                    memset(find, 0, 512); find_len = 0;
                    if(Get_OSK_String_no_lang("Find String (no case sensitive)", (char *) find, 256)==0) {
                        u64 finded;
...
static char help1[]= {
    ...
    "L3/R3 - Changes to different paths (PS3ITA folder, other window folder,  list of devices)\n"
    "\n"
...
void archive_manager()
{
    ...
    if(set_menu2) {
        ...
        display_ttf_string(0, py, "Paste to New File", (set_menu2==6  && (frame & 16)) ? 0 : 0xffffffff, 0, 16, 24); py+= 24;

        display_ttf_string(0, py, "Exit", (set_menu2==7  && (frame & 16)) ? 0 : 0xffffffff, 0, 16, 24); py+= 24;
    ...
    if(set_menu2) {
        ...
        if(new_pad & BUTTON_UP) {
            ...
            if(set_menu2 > 1) set_menu2--;  else {set_menu2 = 7;} 
        }
    
        if(new_pad & BUTTON_DOWN) {
            if(set_menu2 < 7) set_menu2++;  else {set_menu2 = 1;}
        }
    ...
    if(new_pad & BUTTON_CROSS) {
        ...
        if(set_menu2==1) {// new folder
            ...
            if(Get_OSK_String_no_lang("New Folder", buffer1, 256)==0) {
            ...
            if(Get_OSK_String_no_lang("Rename", buffer1, 256)==0) {
        ...
        else if(set_menu2==6) {// Paste to New File
            ...
            if(Get_OSK_String_no_lang("Paste to New File", buffer1, 256)==0) {
    ...
    if(!archive_manager) {
        if(new_pad & BUTTON_CROSS) {
            ...
            if(entries1[sel1].d_type & 1) { // change dir
               ...
               if(!(entries1[sel1].d_type & 2) && (!strcmp(ext, ".self") || !strcmp(ext, ".SELF"))) {
        ...
        if(new_pad & BUTTON_CROSS) {
            ...
            if(entries2[sel2].d_type & 1) { // change dir
                ...
                if(!(entries2[sel2].d_type & 2) && (!strcmp(ext, ".self") || !strcmp(ext, ".SELF"))) {
